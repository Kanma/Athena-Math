...
#ifndef _ATHENA_MATH_MATRIX4_H_
#define _ATHENA_MATH_MATRIX4_H_
...
namespace Math {
    ...
    */
    ...
    /// standard and uses row vectors and left-to-right matrix multiplication.
    ///
    ...
    public:
        //--------------------------------------------------------------------------------
        /// @brief  Assignment from 3x3 matrix
        //--------------------------------------------------------------------------------
        ...
        //--------------------------------------------------------------------------------
        /// @brief  Building a Matrix4 from orientation / scale / position
        ///
        /// @remark Transform is performed in the order scale, rotate, translation, i.e.
        ///         translation is independent of orientation axes, scale does not affect
        ...
        ///
        /// @remark As makeTransform except it build the inverse given the same data as
    ...
    public:
        //--------------------------------------------------------------------------------
        /// @brief  Matrix concatenation using '*'
        //--------------------------------------------------------------------------------
        ...
        ///
        /// Transforms the given 3-D vector by the matrix, projecting the result back into
        /// <i>w</i> = 1
        ///
        /// @remark This means that the initial <i>w</i> is considered to be 1.0, and then
        ///         all the tree elements of the resulting 3-D vector are divided by the
        ///         resulting <i>w</i>.
        //--------------------------------------------------------------------------------
    ...
    public:
        //--------------------------------------------------------------------------------
        /// @brief  Tests 2 matrices for equality
        //--------------------------------------------------------------------------------
        ...
        //--------------------------------------------------------------------------------
        /// @brief  Tests 2 matrices for inequality
        //--------------------------------------------------------------------------------
        inline bool operator!=(const Matrix4& m2) const
        {
            if (m[0][0] != m2.m[0][0] || m[0][1] != m2.m[0][1] || m[0][2] != m2.m[0][2] || m[0][3] != m2.m[0][3] ||
    ...
    public:
        ...
        ///
        /// @param[out] m3x3    Destination matrix
        //--------------------------------------------------------------------------------
    ...
    public:
        //--------------------------------------------------------------------------------
        /// @brief  Sets the translation transformation part of the matrix
        //--------------------------------------------------------------------------------
        ...
        /// @brief  Builds a translation matrix
        //--------------------------------------------------------------------------------
        inline void makeTranslation(Real tx, Real ty, Real tz)
        {
        ...
        //--------------------------------------------------------------------------------
        /// @brief  Gets a translation matrix
        //--------------------------------------------------------------------------------
        ...
        //_____ Scale transformation __________
    public:
        //--------------------------------------------------------------------------------
        ...
        //_____ Affine operations __________
    public:
        //--------------------------------------------------------------------------------
        ...
        //--------------------------------------------------------------------------------
        /// @brief  Check whether or not the matrix is an affine one
        ///
        /// An affine matrix is a 4x4 matrix with row 3 equal to (0, 0, 0, 1), e.g. no
        ...
        ///
        /// @note   The matrices must be affine matrix. @see Matrix4::isAffine.
        //--------------------------------------------------------------------------------
        ...
        //--------------------------------------------------------------------------------
        /// @brief  3-D Vector transformation specially for an affine matrix
        ///
        /// Transforms the given 3-D vector by the matrix, projecting the result back into
        /// <i>w</i> = 1
        ///
        ...
        //--------------------------------------------------------------------------------
        /// @brief  4-D Vector transformation specially for an affine matrix
        ///
        /// @note   The matrices must be affine matrix. @see Matrix4::isAffine.
        //--------------------------------------------------------------------------------
    ...
    /* Made a non-member here because otherwise Matrix4.h and Vector4.h have to try to
       include and inline each other
    */
