/** @file   asm_math.h
    ...
    ASM math routines posted by davepermen et al on flipcode forums, taken from
    <a href="http://www.ogre3d.org/">Ogre3D</a> source code
*/

#ifndef __ATHENA_MATH_ASM_MATH_H__
#define __ATHENA_MATH_ASM_MATH_H__
